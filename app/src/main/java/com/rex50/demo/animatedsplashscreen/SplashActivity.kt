package com.rex50.demo.animatedsplashscreen
...
class SplashActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        //NOTE: It is recommended to keep the time less than 3 seconds
        // but as this is just going to be demo so I'm using 6 seconds
